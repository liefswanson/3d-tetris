...
srcs   = TermColor.cpp Main.cpp ShaderBuilder.cpp VAOBuilder.cpp Renderable.cpp Camera.cpp Tile.cpp Board.cpp RangeMap.cpp Settings.cpp # grid.cpp piece.cpp tile.cpp
